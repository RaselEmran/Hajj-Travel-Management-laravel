        ...
        <div class="col-lg-12">
            <div class="form-group">
             {{ Form::label('option', _lang('option') , ['class' => 'col-form-label']) }}
               {{ Form::select('option',['Hajj' => 'Hajj','Umrah'=>'Umrah'], null, ['class' => 'form-control select', 'data-placeholder' =>  _lang('option'), 'required' => '', 'data-parsley-errors-container' => '#parsley_district_error_area']) }}
